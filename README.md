# Memory Game, made out of the fantasy cards. 
...
A live website can be found [here](https://rashidjumamwinyi.github.io/MLS2/).
...
- The pop up form div's idea cmae from [W3 School](https://www.w3schools.com/html/html_forms.asp)
...
-   The idea used on card shuffle and random pick came from [free Code Camp](freeCodeCamp.org)

### Content

-   All images came from [Pixabay Images](https://pixabay.com/)
-   All weapon icons came from [Font Awesome](https://fontawesome.com/v5.15/icons?d=gallery&p=2)
-   The winner background image came from [GIPHY](https://giphy.com/)
